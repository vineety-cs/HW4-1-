...
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		case 0:
			...
			userNameRecognizerErrorMessage += "A UserName must start with an alphabetic character (A-Z or a-z).\n"; 
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A period, dash, or underscore must be followed by a UserName character in A-Z, a-z, or 0-9.\n"; 
			return userNameRecognizerErrorMessage;
